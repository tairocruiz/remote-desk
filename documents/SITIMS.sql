CREATE TYPE "industrial_logs_status_enum" AS ENUM (
  'approved',
  'remarked',
  'pending'
);

CREATE TYPE "project_logs_status_enum" AS ENUM (
  'approved',
  'remarked',
  'pending'
);
...
CREATE TABLE "industrial_logs" (
  ...
  "status" industrial_logs_status_enum NOT NULL,
  "created_at" timestamp DEFAULT NULL,
  "updated_at" timestamp DEFAULT NULL
);
...
CREATE TABLE "project_logs" (
  ...
  "status" project_logs_status_enum NOT NULL,
  "created_at" timestamp DEFAULT NULL,
  "updated_at" timestamp DEFAULT NULL
);
